...
class BaseService(Generic[ModelType]):
    ...
    def _get_by_id(self, entity_id: Any) -> ModelType:
        ...
        if not entity:
            ...
            raise ResourceNotFoundException(message=error_msg, resource_id=entity_id)
    ...
    def create(self, data: Dict[str, Any]) -> ModelType:
        ...
        try:
            ...
            raise DatabaseOperationException(message=error_msg, original_error=e)
        ...
        try:
            ...
            if not hasattr(self.model_class, "is_active"):
                raise InvalidInputException(
                    message=f"O modelo {self.model_name} não suporta a operação de ativar/desativar"
                )
